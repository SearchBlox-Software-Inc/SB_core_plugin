...
- To upload a custom plugin through UI, it should be in zip file format. Compress the "dist" folder generated by the build command to zip format and rename it (to whatever custom plugin name you prefer. Eg: customui.zip).

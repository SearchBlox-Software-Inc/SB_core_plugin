...
- To upload a custom plugin through UI, it should be in zip file format. Rename the "dist" folder generated by the build command (to whatever custom plugin name you prefer. Eg: customui) and compress it to zip format.
